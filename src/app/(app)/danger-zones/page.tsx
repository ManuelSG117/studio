...
import { MapPin, AlertTriangle, Loader2, List } from 'lucide-react'; // Import icons
import { ReportsMap } from '@/components/reports-map'; // Import the new ReportsMap component
              ...
              <Card className="w-full shadow-sm rounded-lg border border-border bg-card">
                 ...
                 <CardContent>
                     {isLoading ? (
                         ...
                         <p className="text-muted-foreground text-sm">No hay reportes disponibles para mostrar.</p>
                     )}
                 </CardContent>
              </Card>
        </div>
